...
Angenommen es liegen die folgenden Daten vor, die die kognitiven Fähigkeiten von Schülerinnen und Schülern dreidimensional mit den Faktoren `visuell`, `textlich` und `geschwindigkeit` darstellen sollen. Inwiefern liefern CFA Evidenz für die Annahme der Dreidimensionalität?
